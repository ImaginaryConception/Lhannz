 ...
 */
final class Version20230425103853 extends AbstractMigration
{
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE comment ADD CONSTRAINT FK_9474526C487D003D FOREIGN KEY (proposition_jeux_id) REFERENCES proposition_jeux (id) ON UPDATE NO ACTION ON DELETE NO ACTION');
